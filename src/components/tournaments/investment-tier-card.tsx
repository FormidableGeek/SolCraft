...
import { CheckCircle, TrendingUp, DollarSign, Zap, Gem, Star, Award, Percent, Library } from "lucide-react"; // Added Percent, Library
import { riskLevelColorMap, riskLevelIconMap, priorityIconMap } from "@/lib/mock-data"; // Using mock for map

interface InvestmentTierCardProps {
  tier: InvestmentTier;
  onInvest: (tierId: string) => void;
  tokenTicker?: string; // Optional token ticker for display
}
