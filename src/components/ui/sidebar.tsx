...
// Fix for type error: use a union type for props
type SidebarMenuButtonBaseProps = VariantProps<typeof sidebarMenuButtonVariants> & {
  asChild?: boolean
  isActive?: boolean
...
type SidebarMenuButtonProps =
  | (React.ButtonHTMLAttributes<HTMLButtonElement> & SidebarMenuButtonBaseProps & { as?: "button" })
  | (React.AnchorHTMLAttributes<HTMLAnchorElement> & SidebarMenuButtonBaseProps & { as?: "a" })
...
>((props, ref) => {
  const {
    ...
    as,
    ...otherProps
  } = props as SidebarMenuButtonBaseProps & { as?: string }

  const compShouldBeSlot = explicitAsChild || (otherProps as any).asChild
  let Comp: any = "button"
  if (as === "a") Comp = "a"
  if (compShouldBeSlot) Comp = Slot
